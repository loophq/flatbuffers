 ...
 */
static addEmptyBool(builder:flatbuffers.Builder, emptyBool:boolean) {
  builder.addFieldInt8(30, +emptyBool, +false);
};
 ...
 */
static addEmptyLong(builder:flatbuffers.Builder, emptyLong:flatbuffers.Long) {
  builder.addFieldInt64(31, emptyLong, builder.createLong(0, 0));
};
 ...
 */
static addEmptyInt(builder:flatbuffers.Builder, emptyInt:number) {
  builder.addFieldInt32(32, emptyInt, 0);
};
